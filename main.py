...
from Train import Constructor
from model import MDBM_TFBS
...
# all datasets
# dataset_names =
#             ['wgEncodeAwgTfbsBroadDnd41CtcfUniPk', 'wgEncodeAwgTfbsBroadDnd41Ezh239875UniPk', 'wgEncodeAwgTfbsBroadGm12878CtcfUniPk',
#              'wgEncodeAwgTfbsBroadH1hescCtcfUniPk', 'wgEncodeAwgTfbsBroadHelas3CtcfUniPk','wgEncodeAwgTfbsBroadHelas3Ezh239875UniPk',
...
for dataset_name in dataset_names:
    print(dataset_name)
    Train = Constructor(model=MDBM_TFBS())
    accuracy, roc_auc, pr_auc = Train.run_model(dataset_name=dataset_name)
    with open('result/result.txt', 'a') as f:
        f.write("{}: {} {} {}\n".format(dataset_name, accuracy, roc_auc, pr_auc))